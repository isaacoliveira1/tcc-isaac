...
import { KeyboardAvoidingView, Animated, Image } from 'react-native';
...
const initalState = {
  ...
  useEffect(()=> {
    ...
    return(    
        ...
        <Animated.ScrollView options = {{title:"Minha Conta"}} style={[styles.container,{
        opacity: opacity,
        transform: [
        {translateY: offset.y}
        ]
          ...
          <View style={styles.containerLogo}>
            ...
            <Picker style={styles.containerMask}
              selectedValue={state.parent}
              onValueChange={(itemValue, itemIndex) => handleChangeText(itemValue, 'parent')}
            >
            ...
            <Input style={styles.input} secureTextEntry={passwordVisible} 
            ...
            leftIcon={{type:'font-awesome', name:'lock'}} 
            secureTextEntry={passwordVisible} placeholder='Confirmar Senha' autoCorrect={false} 
